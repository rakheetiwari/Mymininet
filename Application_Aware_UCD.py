...
from odl_rest_UCD import *
from Flow_Install_UCD import *
from Flow_Install_UCD1 import *
...
def PollController():   
    ...
    os.system('python Flow_Install_UCD.py')
    ...
    os.system('python Flow_Delete_UCD.py')  # Delete 20% of the flows   
    print "Installing 1st set of flows"
    os.system('python Flow_Install_UCD1.py') #Installing First new set of flows
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install_UCD.py') # Re-install the disrutped flows
...
def ODL():
    topo = MyTopo()
    global net
    net = Mininet(topo, controller=partial(RemoteController, ip='168.150.75.111', port=6633), link=TCLink, host=CPULimitedHost)
    net.start()
