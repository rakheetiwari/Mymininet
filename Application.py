...
def PollController():   
    ...
    os.system('python Flow_Install_1.py') # Install 20 new flows
    ...
    print "Installing 1st set of flows"
    os.system('python Flow_Install_1.py')
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install.py') # Re-install the disrutped flows
    
    elapsed1 = (time.time() - start1)
    print "time elapsed is",elapsed1
    
    start2 = time.time()
    #iPerfTest()

    elapsed2 = (time.time() - start2)
    print "time elapsed is",elapsed2
    ...
    os.system('python Flow_Install_3.py') # Install 20 new flows
    print "Installing 2nd set of flows"
    os.system('python Flow_Install_2.py') # Re-install the disrutped flows
    print "Installing 1st set of flows"
    os.system('python Flow_Install_1.py')
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install.py') # Re-install the disrutped flows
    ...
    print "time elapsed is",elapsed3
