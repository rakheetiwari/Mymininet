...
def get_all_flow_stats():
    resp, content = h.request('http://168.150.75.111:8080/controller/nb/v2/statistics/default/flow', "GET")
...
def get_all_flows_node(nodeid):
    url = 'http://168.150.75.111:8080/controller/nb/v2/flowprogrammer/default/node/OF/' + nodeid
...
def delete_spec_flow_node(node, flowname):
    del_url = 'http://168.150.75.111:8080/controller/nb/v2/flowprogrammer/default/node/OF/' + node + '/staticFlow/' + flowname
    logging.debug('del_url %s', del_url)
    resp, content = h.request(del_url, "DELETE")
    logging.debug('resp %s content %s', resp, content)
...
# Get all edges
def get_all_edges():
    resp, content = h.request('http://168.150.75.111:8080/controller/nb/v2/topology/default', "GET")
