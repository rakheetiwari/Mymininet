...
def PollController():   
    ...
    h4.cmdPrint('ping -c1', h12.IP()) 
    h11.cmdPrint('ping -c1', h19.IP()) 
    h12.cmdPrint('ping -c1', h15.IP()) 
    h14.cmdPrint('ping -c1', h15.IP()) 
    h10.cmdPrint('ping -c1', h22.IP()) 
    h18.cmdPrint('ping -c1', h22.IP()) 
    ...
    os.system('python Flow_Install_1.py') #Installing First new set of flows
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install.py') # Re-install the disrutped flows
    ...
    os.system('python Flow_Install_3.py') #Installing 2nd new set of flows
    print "Re-Installing the disrupted flows" 
    os.system('python Flow_Install.py') #Re-install the disrutped flows
    ...
    os.system('python Flow_Install_2.py')
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install.py') # Re-install the disrutped flows
    ...
    os.system('python get_all_edges.py')
    os.system('python Flow_Delete.py')
    print "Installing 4rth set of flows"
    os.system('python Flow_Install_4.py')
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install.py') # Re-install the disrutped flows
    elapsed4 = (time.time() - start4)
    print "time elapsed after 4rth set of disruption-restore",elapsed4
    ...
    os.system('python get_all_edges.py')
    os.system('python Flow_Delete.py')
    print "Installing 5th set of flows"
    os.system('python Flow_Install_5.py')
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install.py') # Re-install the disrutped flows
    elapsed5 = (time.time() - start5)
    
    print "time elapsed after 5th set of disruption-restore",elapsed5
    #iPerfTest()
