...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        h1 = self.addHost( 'h1', ip='10.0.1.1/24', defaultRoute='gw 10.0.1.1', sched='rt' )
        h2 = self.addHost( 'h2', ip='10.0.2.1/24', defaultRoute='gw 10.0.2.1', sched='rt' )
        h3 = self.addHost( 'h3', ip='10.0.3.1/24', defaultRoute='gw 10.0.3.1', sched='rt' )
        h4 = self.addHost( 'h4', ip='10.0.4.1/24', defaultRoute='gw 10.0.4.1', sched='rt' )
        h5 = self.addHost( 'h5', ip='10.0.5.1/24', defaultRoute='gw 10.0.5.1', sched='rt' )
        h6 = self.addHost( 'h6', ip='10.0.6.1/24', defaultRoute='gw 10.0.6.1', sched='rt' )
        h7 = self.addHost( 'h7', ip='10.0.7.1/24', defaultRoute='gw 10.0.7.1', sched='rt' )
        h8 = self.addHost( 'h8', ip='10.0.8.1/24', defaultRoute='gw 10.0.8.1', sched='rt' )
        h9 = self.addHost( 'h9', ip='10.0.9.1/24', defaultRoute='gw 10.0.9.1', sched='rt' )
        h10 = self.addHost( 'h10', ip='10.0.10.1/24', defaultRoute='gw 10.0.10.1', sched='rt' )
        h11 = self.addHost( 'h11', ip='10.0.11.1/24', defaultRoute='gw 10.0.11.1', sched='rt' )
        h12 = self.addHost( 'h12', ip='10.0.12.1/24', defaultRoute='gw 10.0.12.1', sched='rt' )
        h13 = self.addHost( 'h13', ip='10.0.13.1/24', defaultRoute='gw 10.0.13.1', sched='rt' )
        h14 = self.addHost( 'h14', ip='10.0.14.1/24', defaultRoute='gw 10.0.14.1', sched='rt' )
        h15 = self.addHost( 'h15', ip='10.0.15.1/24', defaultRoute='gw 10.0.15.1', sched='rt' )
        h16 = self.addHost( 'h16', ip='10.0.16.1/24', defaultRoute='gw 10.0.16.1', sched='rt' )
        h17 = self.addHost( 'h17', ip='10.0.17.1/24', defaultRoute='gw 10.0.17.1', sched='rt' )
        h18 = self.addHost( 'h18', ip='10.0.18.1/24', defaultRoute='gw 10.0.18.1', sched='rt' )
        h19 = self.addHost( 'h19', ip='10.0.19.1/24', defaultRoute='gw 10.0.19.1', sched='rt' )
        h20 = self.addHost( 'h20', ip='10.0.20.1/24', defaultRoute='gw 10.0.20.1', sched='rt' )
        h21 = self.addHost( 'h21', ip='10.0.21.1/24', defaultRoute='gw 10.0.21.1', sched='rt' )
        h22 = self.addHost( 'h22', ip='10.0.22.1/24', defaultRoute='gw 10.0.22.1', sched='rt' )
        h23 = self.addHost( 'h23', ip='10.0.23.1/24', defaultRoute='gw 10.0.23.1', sched='rt' )
        h24 = self.addHost( 'h24', ip='10.0.24.1/24', defaultRoute='gw 10.0.24.1', sched='rt' )
