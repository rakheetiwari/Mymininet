...
def iPerfTest():
    with open('/home/mininet/mininet/custom/Mymininet/40connections.txt', 'r') as content_file:
...
def PollController():   
    ...
    os.system('python Flow_Install_40.py')
    ...
    os.system('python Flow_Install_40_1.py') #Installing First new set of flows
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install_40.py') # Re-install the disrutped flows
    ...
    os.system('python Flow_Install_40_2.py') #Installing 2nd new set of flows
    print "Re-Installing the disrupted flows" 
    os.system('python Flow_Install_40.py') #Re-install the disrutped flows
    ...
    os.system('python Flow_Install_4-_3.py')
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install_40.py') # Re-install the disrutped flows
