...
def c2(x,bandwidth_ext):
        ...
        if flag !=1:
            ...
            print "BandWidth Calculated and Flow installed sucessfully",bandwidthDict_Copy            
        return flag            

if __name__ == '__main__':

 with open('/home/mininet/mininet/custom/Mymininet/20connections_2.txt', 'r') as content_file:
...
fl = open('/home/mininet/mininet/custom/Mymininet/FlowCount.txt', 'wb')
pickle.dump(path_flow_list_cp, fl)
fl.close()
