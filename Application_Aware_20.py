...
def PollController():   
    ...
    os.system('python Flow_Install_20.py')
    ...
    h1.cmdPrint('ping -c1', h6.IP())
    h1.cmdPrint('ping -c1', h5.IP())
    h3.cmdPrint('ping -c1', h20.IP())
    h3.cmdPrint('ping -c1', h21.IP())
    h10.cmdPrint('ping -c1', h12.IP())
    h4.cmdPrint('ping -c1', h12.IP())
    h15.cmdPrint('ping -c1', h19.IP())
    h13.cmdPrint('ping -c1', h19.IP())
    ...
    os.system('python Flow_Install_20_1.py') #Installing First new set of flows
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install_20.py') # Re-install the disrutped flows
    ...
    os.system('python Flow_Install_20_2.py') #Installing 2nd new set of flows
    print "Re-Installing the disrupted flows" 
    os.system('python Flow_Install_20.py') #Re-install the disrutped flows
    ...
    os.system('python Flow_Install_20_3.py')
    print "Re-Installing the disrupted flows"
    os.system('python Flow_Install_20.py') # Re-install the disrutped flows
