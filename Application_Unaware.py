...
def PollController():
    ...
    net.configLinkStatus( 's14', 's13', 'down' ) #Tearing the link down
    ...
    print "Restoring the link between S7 and S8"
    net.configLinkStatus( 's7', 's8', 'up' ) #Restoring the link
    print "Restoring the link between S19 and S20"
    net.configLinkStatus( 's19', 's20', 'up' ) #Restoing the link
    print "Restoring the link between S5 and S4"
    net.configLinkStatus( 's5', 's4', 'up' ) #Restoring the link
